...
void allocation(Scalar **pointer, int mem_option)
{
    ...
    {
    case(0):
        cudaMallocManaged((void **)pointer, sizeof()*);
        break;
    case(1):
...
template void allocation<int>(int **pointer, int mem_option);
template void allocation<float>(float **pointer, int mem_option);
template void allocation<double>(double **pointer, int mem_option);
...
float gpu_ax_time(Scalar *pointer, int runs, int version, int mem_option)
{
    ...
    case(0) :               //kernel_standart
        ...
        else if (mem_option == 1)
        {
            ...
            cudaHostGetDevicePointer((void **)&d_pointer, (void *)data, 0);
...
template float gpu_ax_time<int>(int* pointer, int runs, int version, int mem_option);
template float gpu_ax_time<float>(float* pointer, int runs, int version, int mem_option);
template float gpu_ax_time<double>(double* pointer, int runs, int version, int mem_option);
...
template void gpu_ax_overall<int>(int* pointer, int version, int mem_option);
template void gpu_ax_overall<float>(float* pointer, int version, int mem_option);
template void gpu_ax_overall<double>(double* pointer, int version, int mem_option);
...
template void cleanup<int>(int *pointer, int method);
template void cleanup<float>(float *pointer, int method);
template void cleanup<double>(double *pointer, int method);
