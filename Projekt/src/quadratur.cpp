...
std::vector<double> assembleFem::get_quadrature_xpoints_2d_1(int e) //Berechnet die x-Koordinaten der Gauss-Quadraturpunkte für das Intervall für die Seitenflaeche (X-Y-Ebene)
{
    //Berechnet die Translation und die Skalierung
    double e_x(getx(e));
    double a1((1.0-sqrt(3.0/5.0))*_h/2.0 + e_x);
...
std::vector<double> assembleFem::get_quadrature_ypoints_2d_1(int e) //Berechnet die y-Koordinaten der Gauss-Quadraturpunkte für das Intervall für die Seitenflaeche (X-Y-Ebene)
{
    //Berechnet die Translation und die Skalierung
    double e_y(gety(e));
    double a1((1.0-sqrt(3.0/5.0))*_h/2.0 + e_y);
...
std::vector<double> assembleFem::get_quadrature_ypoints_2d_3(int e) //Berechnet die y-Koordinaten der Gauss-Quadraturpunkte für das Intervall für e Seitenflaeche (Y-Z-Ebene)
{
    //Berechnet die Translation und die Skalierung
    double e_y(gety(e));
    double a1((1.0-sqrt(3.0/5.0))*_h/2.0 + e_y);
