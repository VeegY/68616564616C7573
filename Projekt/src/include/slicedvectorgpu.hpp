...
* Dateiname:                slicedvectorgpu.hpp
* Erstellt:                 24.11.15
* Autor / Ansprechpartner:  David
*
* Kurzbeschreibung:
* - Deklariert die Template-Klasse slicedvectorgpu.
*/

#ifndef __SLICEDVECTORGPU_HPP_
#define __SLICEDVECTORGPU_HPP_
